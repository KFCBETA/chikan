...
public class EntertainmentViewPager extends FragmentActivity {

    Entertainment_viewPaperAdapter entertainment_viewAdapter;
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_entertainment_view_pager);
        Bundle bundle = this.getIntent().getExtras();
        int position = bundle.getInt("position");
        file_count = bundle.getInt("file_count");

        entertainment_viewAdapter = new Entertainment_viewPaperAdapter(getSupportFragmentManager());

        viewPager = (ViewPager)findViewById(R.id.entertainment_pager);
        viewPager.setAdapter(entertainment_viewAdapter);
...
//                break;
    ...
    public class Entertainment_viewPaperAdapter extends FragmentStatePagerAdapter
    {
        public Entertainment_viewPaperAdapter(FragmentManager fm)
        {
            super(fm);
        }
    ...
    public static class ViewFragment extends android.support.v4.app.Fragment
    {
        ...
        {
            View view_viewpager = inflater.inflate(R.layout.fragment_entertainment_view_pager,container,false);
            ...
            ((TextView)view_viewpager.findViewById(R.id.entertainment_title)).setText(tmp_title);
            ((TextView)view_viewpager.findViewById(R.id.entertainment_article)).setText(tmp);
